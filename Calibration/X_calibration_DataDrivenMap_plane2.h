...
#ifndef X_calibration_DataDrivenMap_plane2_h
#define X_calibration_DataDrivenMap_plane2_h
...
class X_calibration_DataDrivenMap_plane2 {
public :
...
// Fixed size dimensions of array or collections stored in the TTree if any.
   ...
   X_calibration_DataDrivenMap_plane2(TString filename, int corr, int i_year, int i_month, int i_date, int f_date, std::string sample);
   virtual ~X_calibration_DataDrivenMap_plane2();
...
#ifdef X_calibration_DataDrivenMap_plane2_cxx
X_calibration_DataDrivenMap_plane2::X_calibration_DataDrivenMap_plane2(TString filename, int corr, int i_year, int i_month, int i_date, int f_date, std::string sample) : fChain(0) 
{
...
X_calibration_DataDrivenMap_plane2::~X_calibration_DataDrivenMap_plane2()
{
   if (!fChain) return;
   delete fChain->GetCurrentFile();
}

Int_t X_calibration_DataDrivenMap_plane2::GetEntry(Long64_t entry)
{
// Read contents of entry.
   if (!fChain) return 0;
   return fChain->GetEntry(entry);
}
Long64_t X_calibration_DataDrivenMap_plane2::LoadTree(Long64_t entry)
{
...
void X_calibration_DataDrivenMap_plane2::Init(TTree *tree)
{
...
Bool_t X_calibration_DataDrivenMap_plane2::Notify()
{
...
void X_calibration_DataDrivenMap_plane2::Show(Long64_t entry)
{
...
Int_t X_calibration_DataDrivenMap_plane2::Cut(Long64_t entry)
{
...
#endif // #ifdef X_calibration_DataDrivenMap_plane2_cxx
