...
// found on file: /uboone/app/users/wospakrk/DataDrivenMap/XYZcorrection.root
//////////////////////////////////////////////////////////

#ifndef X_calibration_DataDrivenMap_h
#define X_calibration_DataDrivenMap_h
...
class X_calibration_DataDrivenMap {
public :
...
// Fixed size dimensions of array or collections stored in the TTree if any.
   ...
   X_calibration_DataDrivenMap(TString filename, int corr, std::string sample, std::string type);
   virtual ~X_calibration_DataDrivenMap();
...
#ifdef X_calibration_DataDrivenMap_cxx
X_calibration_DataDrivenMap::X_calibration_DataDrivenMap(TString filename, int corr, std::string sample, std::string type) : fChain(0) 
{
...
X_calibration_DataDrivenMap::~X_calibration_DataDrivenMap()
{
   if (!fChain) return;
   delete fChain->GetCurrentFile();
}

Int_t X_calibration_DataDrivenMap::GetEntry(Long64_t entry)
{
// Read contents of entry.
   if (!fChain) return 0;
   return fChain->GetEntry(entry);
}
Long64_t X_calibration_DataDrivenMap::LoadTree(Long64_t entry)
{
...
void X_calibration_DataDrivenMap::Init(TTree *tree)
{
...
Bool_t X_calibration_DataDrivenMap::Notify()
{
...
void X_calibration_DataDrivenMap::Show(Long64_t entry)
{
...
Int_t X_calibration_DataDrivenMap::Cut(Long64_t entry)
{
...
#endif // #ifdef X_calibration_DataDrivenMap_cxx
